    ...
    <div class="mx-7 lg:h-auto">
      ...
      <div class="fixed w-full z-40 start-0 top-0 px-10 py-3 md:py- lg:py-5 flex flex-wrap items-center justify-between bg-indigo-950 drop-shadow-xl">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span class="font-custom self-center text-2xl font-semibold whitespace-nowrap">Lenscape</span>
        </a>
        <div class="relative flex lg:order-2 space-x-5 lg:space-x-0 rtl:space-x-reverse items-center">
          <button type="button" class="font-custom text-blue-500 bg-white font-medium rounded-full text-sm px-5 py-2 text-center flex border border-blue-400 relative">Get Started
        ...
        <div 
         ...
         id="navbar-sticky"
        >
          <ul class="font-custom flex flex-col p-4 lg:py-1 mt-4 font-normal border-t-2 border-indigo-200 lg:space-x-0 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0 lg:px-3 text-black text-center">
            <li>
        ...
        <div class="hidden w-full lg:block md:hidden sm:hidden md:w-auto" id="navbar-sticky">
          <ul class="font-custom py-1 px-6 text-sm font-medium flex flex-col rounded-full md:flex-row md:space-x-6 rtl:space-x-reverse md:mt-0 md:border-0 bg-white">
      ...
      <div class="mt-24 md:mt-24 lg:mt-28 md:py-0 flex flex-row rounded-2xl lg:py-12 px-10 justify-between bg-gradient-to-b from-indigo-950 via-indigo-800 to-indigo-400">
        <div class="flex flex-col py-24 text-center md:text-center lg:text-left">
          <!-- teks (kiri) -->
          <p class="font-custom font-semibold text-4xl md:text-5xl lg:text-5xl tracking-normal justify-center py-2 sm:py-0 sm:justify-start">{{ caption }}</p>
          <p class="font-custom font-light text-2xl md:text-4xl lg:text-4xl tracking-normal py-5">- Unveil Your Story with Lenscape!</p>
          <!-- gambar (kanan) -->
        </div>
